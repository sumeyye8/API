...
public class Get07 extends JsonplaceholderBaseUrl {
    ...
    public void get01(){
        ...
        // 3) Send The Reuest And Get The Response
        ...
        List<Integer> idler=json.getList("findAll{it.id>190}.id");  // Groovy Languae = Java temmelli programlama dili
        System.out.println("d'si 190'dan Buyuk Olanlar : " +idler);
        ...
        System.out.println("Id'si 5'ten kucuk olan userdler : " +userIdler);

        // Assert that the number of userIds whose ids are less than 5 is 4 ==> id si 5 den kucuk olan 4 tane userId oldugunu dogrulayin
        assertEquals("Id'si 5'ten kucuk olan user id'ler 4 tane degil", 4, userIdler.size());
        ...
        assertTrue("Id'si 5'ten kucuk olan title'lardan herhangi bir tanesi delectus aut atem icermemektedir ",
        ...
        // stream olunca akis icinde ariyor
