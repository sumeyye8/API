...
public class Get16 extends DummyRestApiBaseUrl {
    ...
    */
    ...
    public void get16(){
        ...
        response.then().assertThat().body("data.employess", hasSize(24),"data.employee_name",hasItems("Tiger Nixon", "Garrett Winters"));
        ...
        // iv) The greatest age is 66
        System.out.println(ages.get(ages.size() - 1));  // en buyuk yasi getirir
        assertEquals(66, (int) (ages.get(ages.size()-1)));    // dogruladik
