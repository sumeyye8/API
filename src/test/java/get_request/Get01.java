...
public class Get01 {
    ...
    3) Otomasyon testlerimizi yaparken asagidaki adimlari izliyoruz
       ...
       b) Test Case yaziyoruz
            ...
            i) Test Case azşminda 'Gherkin' dilini kullanacagiz. Bizler yazilim diline hakim olsak da, karsimizdaki
            ...
            - Given : On kosullar,
            - When : Yapilacak aksiyonlar icin ( get(), put(), post(), patch(), delete() ),
       ...
       c) Test kodlarimizi yazmaya baslayacagiz
            ...
            iii) Type code to send requrest ( talep gondermek icin kod yazimi ),
